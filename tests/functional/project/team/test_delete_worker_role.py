...
class ProjectDeleteWorkerRoleTestCase(BaseTestCase):
    ...
    def test_delete_teammate_role_check_auth_fail(self):
        ...
        with self.app.test_client() as test_client:
            ...
            teammate_data = {"user_id": user.id, "project_id": project.id, "teammate_role_id": WorkerRole.get_admin().id}
    ...
    def test_delete_teammate_role_multiple_success(self):
        ...
        with self.app.test_client() as test_client:
            ...
            assert Teammates.query.filter_by(user_id=user.id, project_id=project.id, teammate_role_id=WorkerRole.get_admin().id).first() is None
    ...
    def test_delete_teammate_role_users_not_exists(self):
        ...
        with self.app.test_client() as test_client:
            ...
            teammate_data = {"user_id": "asd", "project_id": project.id, "teammate_role_id": WorkerRole.get_admin().id}
    ...
    def test_delete_teammate_role_project_required(self):
        ...
        with self.app.test_client() as test_client:
            ...
            teammate_data = {"user_id": user.id, "project_id": "1", "teammate_role_id": WorkerRole.get_admin().id}
